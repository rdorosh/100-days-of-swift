...
//  Project8
//
//  Created by Ruslan Dorosh on 24.06.2022.
//
    ...
    override func loadView() {
        ...
        for row in 0..<4 {
            for col in 0..<5 {
                ...
                letterButton.setTitleColor(self.view.tintColor, for: .normal)
...
//            }
            ...
            let ac = UIAlertController(title: "Incorrect!", message: "Pleas, try again!", preferredStyle: .alert)
